...
void placePlayerChar(playerChar_t *PC, Map *map){
...
//      6  5  4
//
void generateMove(Map *m, playerChar_t *p, NPC *npc, arrE_t *arr){
...
void findShortestPaths(playerChar_t *p, Map *map, NPC *npc, Map *m){
...
void prepMapPCMovingInto(Map *movingTo, Map *movingFrom){
...
void dummyFunction(Map *map, playerChar_t *player, NPC *npc){
